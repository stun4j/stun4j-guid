...
public abstract class ZkGuidNode {
  ...
  public static short[] start(String zkConnectStr, String zkNamespace) throws Exception {
    return start(zkConnectStr, zkNamespace, null);
  }

  public static short[] start(String zkConnectStr, String zkNamespace, String ipStartWith) throws Exception {
  ...
  public static short[] start(Builder zkClientBuilder, String ipStartWith) throws Exception {
    ...
    try {
      ...
      return ZkLocks.of(client, ZK_LOCK_PATH_ROOT, () -> {
        try {
          ...
          short workerId = Short.parseShort(highAsWorkerId, 2);
          LOG.info("guid-node started [datacenterId={}, workerId={}]", datacenterId, workerId);
          return new short[] { datacenterId, workerId };
        } catch (Exception e) {
