/*
 * Copyright (c) 2003, 2013, Oracle and/or its affiliates. All rights reserved. ORACLE PROPRIETARY/CONFIDENTIAL. Use is
 * subject to license terms.
 */
package com.stun4j.guid.support;
 ...
 * <p>
 * There exist different variants of these global identifiers. The methods of this class are for manipulating the
 * Leach-Salz variant, although the constructors allow the creation of any variant of UUID (described below).
 * <p>
 ...
 * </pre>
 * <p>
 * The variant field contains a value which identifies the layout of the {@code UUID}. The bit layout described above is
 * valid only for a {@code
 ...
 * UUID}. There are four different basic types of UUIDs: time-based, DCE security, name-based, and randomly generated
...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
   ...
   * <p>
   * The UUID string representation is as described by this BNF: <blockquote><pre>
   * {@code
  ...
  // mj:added->
  public String toStringWithoutHyphen() {
    // return (digits(mostSigBits >> 32, 8) + "-" + digits(mostSigBits >> 16, 4) + "-" + digits(mostSigBits, 4) + "-"
    // + digits(leastSigBits >> 48, 4) + "-" + digits(leastSigBits, 12));
    // mj:changed instead
    return (new StringBuilder(digits(mostSigBits >> 32, 8)).append(digits(mostSigBits >> 16, 4))
        .append(digits(mostSigBits, 4)).append(digits(leastSigBits >> 48, 4)).append(digits(leastSigBits, 12))
        .toString());
  }
  // <-
