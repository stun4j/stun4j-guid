/*
 * Copyright © 2018 Coda Hale (coda.hale@gmail.com) Licensed under the Apache License, Version 2.0 (the "License"); you
 ...
 * <p>
 * For each UUID, it uses SipHash-2-4 to hash four single-byte values selected for their high Hamming distances from
 * each other. The first two results are used to re-key the hash; the second two are used to produce the UUID.
 * <p>
 * This design allows for very fast UUID generation (~50ns/UUID) as well as forward-secrecy (i.e. a compromised
 * generator reveals no information about previously-generated UUIDs).
 * <p>
 * To provide backward-secrecy (i.e. a compromised generator reveals no information about UUIDs which will be
 * generated), the generator should be periodically re-seeded.
 */
public class UUIDFast {
